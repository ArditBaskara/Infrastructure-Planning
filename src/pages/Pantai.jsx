          ...
          <div className="w-full max-w-lg bg-blue-900 p-6 rounded-lg shadow-lg mt-8 sm:mt-6 md:mt-4 lg:mt-4 xl:mt-0 overflow-y-auto max-h-screen">
            ...
            <form className="space-y-4">
              <div className="space-y-3">
                {[
                  "Apakah pantai ini memiliki garis pantai yang panjang?",
                  "Apakah terdapat banyak vegetasi di sekitar pantai ini?",
                  "Apakah pantai ini sering mengalami abrasi?",
                  "Apakah area pantai ini ramai dikunjungi wisatawan?",
                ].map((question, index) => (
                  <label
                    key={index}
