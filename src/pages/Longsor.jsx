...
import bg from "../assets/bg_10.png";
    ...
    <>
      ...
      >
        <div className="w-full h-full flex flex-col justify-start items-center px-4 mt-4">
          ...
          <div className="w-full max-w-lg bg-yellow-900 p-6 rounded-lg shadow-lg mt-8 sm:mt-6 md:mt-4 lg:mt-4 xl:mt-0 overflow-y-auto max-h-screen">
            <h2 className="text-xl md:text-2xl font-bold mb-4 text-white text-center">Risiko Longsor dan Kestabilan Lereng</h2>
            <form className="space-y-4">
              <div className="space-y-3">
                {[
                  "Apakah wilayah ini memiliki riwayat kejadian longsor sebelumnya?",
                  "Apakah lereng di wilayah ini memiliki kemiringan yang curam?",
                  "Apakah terdapat retakan atau tanda-tanda keruntuhan di lereng?",
                  "Apakah sistem drainase di lereng ini memadai untuk mencegah longsor?",
                  "Apakah aktivitas manusia di wilayah ini meningkatkan risiko longsor?",
                ].map((question, index) => (
                  <label
                    key={index}
                  ...
                  >
                    <input
                      ...
                      className="w-4 h-4 rounded border-yellow-600 focus:ring-yellow-500 mt-1"
                    />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="w-full sm:w-auto mt-4 py-2 px-4 bg-yellow-700 text-white rounded hover:bg-yellow-800 transition-colors duration-200"
                >
                  Previous
                </button>
                <button
