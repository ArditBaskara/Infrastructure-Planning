...
import bg from "../assets/bg_7.png";
      ...
      >
        <div className="w-full h-full flex flex-col justify-start items-center px-1 mt-1">
          ...
          <div className="w-full max-w-lg bg-red-900 p-6 rounded-lg shadow-lg mt-8 sm:mt-6 md:mt-4 lg:mt-4 xl:mt-0 overflow-y-auto max-h-screen">
            <h2 className="text-xl md:text-2xl font-bold mb-4 text-white text-center">Potensi Bencana Ekstrem</h2>
            <form className="space-y-4">
              <div className="space-y-3">
                {[
                  "Apakah wilayah ini rawan terhadap gempa bumi?",
                  "Apakah wilayah ini sering mengalami banjir ekstrem?",
                  "Apakah ada risiko tanah longsor di area ini?",
                  "Apakah wilayah ini berpotensi terkena angin puting beliung?",
                ].map((question, index) => (
                  <label
                    key={index}
